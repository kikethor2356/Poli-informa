...
<head>
    ...
    <title>Administración Avisos</title>
</head>
<body>
    <div id="productos">
        ...
        <main id="principal-productos">
            <section id="section-productos">
                <div id="mostrarProductos">
                    <h1>Avisos</h1>
                    <button id="nuevoProducto" class="nuevoProducto" name="nuevoProducto" title="Agregar Aviso" onclick="mostrarVentana()"><i class="fa-solid fa-circle-plus"></i> Agregar Avisos</button>   
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($row) > 0){ 
                                ...
                                foreach($row as $fila){
                                    ...
                                    ?>                                
                                    <tr>
                                        <td class="<?php echo $clase_fila; ?>"><input type="text" id="campoNombre" name="campoNombre" value="<?php echo $fila['informacion']; ?>" readonly></td>
                                        ...
                                        <td class="<?php echo $clase_fila; ?>" id="cabezaAcciones">
                                            <div class="acciones-buttons">
                                                <button class="iconoVer" type="button" onclick="abrirVentanaVisualizar('<?php echo $fila['informacion']; ?>', '<?php echo $fila['foto']; ?>')"><i class="fa-solid fa-eye"></i></button>
                                                <!-- Aquí cambiamos el ID a una clase y agregamos atributos de datos para toda la fila -->
                                                <button type="button" class="iconoEditar" title="Editar registro" onclick="abrirVentanaEditar('<?php echo $fila['id_aviso']; ?>', '<?php echo $fila['informacion']; ?>', '<?php echo $fila['foto']; ?>', '<?php echo $fila['foto']; ?>')"><i class="fa-solid fa-pen-to-square"></i></button>
                                                <form id="eliminarForm_<?php echo $fila['id_aviso']; ?>" action="EliminarAvisos.php" method="POST">
                                                <input type="hidden" name="eliminar_id" value="<?php echo $fila['id_aviso']; ?>">
                                                ...
                                                <button type="button" class="iconoEliminar" title="Eliminar registro" onclick="mostrarConfirmacion('<?php echo $fila['id_aviso']; ?>')"><i class="fa-solid fa-trash-can"></i></button>
                                            </form>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="ventanaVisualizarProducto" id="ventanaVisualizarProducto">
        <div class="contenidoVentanaVisualizarProducto">
            ...
            <h2>Mostrar Aviso</h2>
            <textarea name="" id="nombreProducto" cols="30" rows="10" readonly></textarea>
    ...
    <script>
        function abrirVentanaVisualizar(informacion, imagen) {
            ...
            nombreProducto.textContent = "Informacion: " + informacion;
    ...
    <div class="ventanaEditarProducto">
        ...
        <div class="contenidoVentanaEditarProducto">
            ...
            <form action="ModificarAvisos.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="id_categoria1" name="id_aviso">

                <textarea type="text" id="categoria1" name="informacion" placeholder="Informacion del aviso" cols="30" rows="10"></textarea>
    ...
    <script>
        function abrirVentanaEditar(id, informacion, imagen, nombre_imagen){
    ...
    <!-- EDITAR: Ventana de confirmacion la editacion -->
    <?php
    ...
    <div class="ventanaEmergente" >
        ...
        <span class="close" onclick="cerrarAgregar()">&times;</span>
            <h2>Registro</h2>
            <form action="AgregarAvisos.php" method="post" enctype="multipart/form-data">
                
                <textarea type="text" id="informacion" name="informacion" required placeholder="Informacion requerida" cols="30" rows="10"></textarea>
    ...
    <script>
        function cerrarAgregar() {
            document.querySelector(".ventanaEmergente").classList.remove('enseñar_modal'); // Oculta la ventana de edición
        }
    ...
    <!-- Agregar: Ventena de confirmacion -->
    <?php
