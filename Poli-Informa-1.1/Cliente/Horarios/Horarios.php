                                ...
                                if (isset($horario[$dia])) {
                                    foreach ($horario[$dia] as $hora) {
                                        if ($i >= (int)$hora['hora_inicio'] && $i <=  (int)$hora['hora_fin'] - 1) {
                                            echo '<a onclick="abrirVentanaMaestro()" href="../../Administrador/Horarios/ControllerShowProfile.php?nombre=' . $hora["maestro"] . '" style="margin-right: 10px; text-decoration: none; color: black ;">' . $hora["maestro"] . '</a>';
                                        }
                                    }
                                }
                                echo "</td>";
