...
$query_productos = "SELECT p.*, c.categoria_nombre FROM cafeteriacanchas p LEFT JOIN categorias_cafeteria c ON p.prodcategoria_id = c.categoria_id";
...
foreach ($productos_por_categoria as $categoria => $productos) {
    ...
    foreach ($productos as $producto) {
        ...
        echo '<img src="../../Administrador/Cafeteria/Agregar/temp2/' . $producto['imagen'] . '" alt="' . $producto['nombre_producto'] . '">';
        echo '</div>';
